...
namespace BuildingSystemFolder
{
    public class FloorPlacementMethod : IPlacementMethod
    {
        ...
        public bool CanPlace(Vector3Int cellPos, IPlaceableItemData placeableItemData, RotationData rotationData)
        {
            ...
            if (GameData.Instance.placementDataHandler.ContainsKey(cellPos, placeableItemData.Size, rotationData, ePlacementLayer.Floor)) return false;
            return true;
        }
            ...
            RotationData rotationData)
        {
            ...
            //     new PlacementData(placeableItemData, newObject, rotationData), ePlacementLayer.Floor);
