...
namespace System
{
    public class GridHandler : Singleton<GridHandler>
    {
        ...
        {
            // Floor Shader
            float minimumOffset = 0.001f;
            Material shaderMaterial = new Material(gridSahder);
            ...
            // Wall Left Shader
            Material shaderLeftWallMaterial = new Material(gridSahder);
            ...
            // Wall Right Shader
            Material shaderRightWallMaterial = new Material(gridSahder);
