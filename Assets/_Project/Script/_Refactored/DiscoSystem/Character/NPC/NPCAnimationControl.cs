...
namespace DiscoSystem.Character.NPC
{
    ...
    public class NPCAnimationControl : IAnimationController
    {
        ...
        public void PlayActionAnimation(eActionAnimationType eActionAnimationType)
        {
            switch (eActionAnimationType)
            {
                ...
                case eActionAnimationType.NPC_HoldDrink:
                    ...
                    animancer.Layers[1].Mask = _npcAnimationSo.DrinkBeer.Mask;
                    animancer.Layers[1].Play(_npcAnimationSo.DrinkBeer.Idle, _npcAnimationSo.animationDuration);
        ...
        private IEnumerator CancelActionAnim()
        {
            ...
            animancer.Layers[1].Play(_npcAnimationSo.DrinkBeer.Action, _npcAnimationSo.animationDuration);
